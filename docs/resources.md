...
- **Pod Execution Role**: arn:aws:iam::ACCOUNT:role/EksFargatePodExecutionRole

### ECR Repository
- **Name**: mcp-gateway-registry
- **URI**: ACCOUNT.dkr.ecr.us-east-1.amazonaws.com/mcp-gateway-registry
...
### Target Group
- **Name**: mcp-gateway-tg
- **ARN**: arn:aws:elasticloadbalancing:us-east-1:ACCOUNT:targetgroup/mcp-gateway-tg/18ec9cffd9008a39
- **Port**: 7860
- **Protocol**: HTTP
...
### ACM Certificate
- **ARN**: arn:aws:acm:us-east-1:ACCOUNT:certificate/CERTIFICATE-ID
...
- **Replicas**: 2
- **Image**: ACCOUNT.dkr.ecr.us-east-1.amazonaws.com/mcp-gateway-registry:4e41864e857f572380f05aad51145dbf9ddf5a41
- **Resources**:
